...
# Install essential system dependencies and Python 3.9
...
RUN python3 -m ipykernel install --user --name "python3.9" && \
    rm -r /home/ma-user/.local/share/jupyter/kernels/python3.9/logo-*
